...
export const metadata: Metadata = {
  ...
  description:
    "XBert is built by Nextiva — nearly 20 years serving 100,000+ businesses, 1B+ customer interactions a year, 99.999% uptime. The infrastructure underneath the AI.",
};
